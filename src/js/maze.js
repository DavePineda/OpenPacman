...
const GHOST_STARTS = [
  { x: 13, y: 14, kind: 'hunter',  speed: 0.08 }, // dentro de la pen
  { x: 14, y: 14, kind: 'random',  speed: 0.1  }, // dentro de la pen
  { x: 12, y: 14, kind: 'erratic', speed: 0.09 }, // dentro de la pen
  { x: 15, y: 14, kind: 'timid',   speed: 0.07 }, // dentro de la pen
];
